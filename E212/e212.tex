...
$(33.4 \pm 3.5)~\text{mb}$, respectively, by counting the total number of such collisions in comparison to the total number of incident protons. The charged multiplicity was then found to be 4.375, giving an approximate neutral pion multiplicity of 1.094. This is in disagreement with the neutral pion multiplicity of $0.5026 \pm 0.0003$ calculated from the number of observed pair productions, reasoned to be due to a low production count of photons in the proton-proton collision. The momenta of a $\pi \mu e$ decay for a pion at rest were calculated, giving momenta for both the $\mu^+$ and $\nu_\mu$ of $27.6 \pm 1.3$~MeV/c, in reasonable agreement with a theoretical value of 29.8~MeV/c. Lastly, two strange neutral particle decays were analysed with kinematics and quantum number conservation to determine the identities of the neutral particles. Both particles were found to be $\Lambda^0$ decaying to a proton and negatively charge pion, though the first was created by the process p$\,$p$\,\rightarrow\,$p$\,$K$^+\,\Sigma^0 \rightarrow \, $p$\,$K$^+\,(\gamma \, \Lambda^0)$, while the second was directly created from a proton-proton collision. The confidence in the identifications of these neutral particle is low, however, due to large uncertainties in the calculated particle momenta and masses.
