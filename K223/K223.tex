...
\twocolumn[ %makes a one collumn abstract
...
\begin{figure}[!h]
	...
	\label{fig:prompt}
\end{figure}
%TODO what are these measured values at 61 and 63ns?
...
%TODO could talk about taking more data for the prompt curve in order to get a more accurate theoretical accidental coincidences prediction
\begin{figure}
	\centering
...
%TODO order bibliography by order of appearance and use the one style (Bence).
\bibitem{sieg}
