...
The ATLAS detector is one of the several detectors in the LHC (Large Hadron Collider), a circular accelerator in Geneva, Switzerland. In it, two proton beams with the energy of 6.5~TeV each are collided with each other. The resulting legion %horde? multitude?
