...
Real ATLAS data was analyzed using ROOT. After a short introduction to visualizing events with the help of the program ATLANTIS, a calibration of the electromagnetic calorimeter raw data was done where $Z^0 \, \rightarrow \, ee$ events were examined and coefficients multiplying the deposited energy measured in different detector regions were assigned to achieve the well-known $Z^0$ mass. As the main part of the experiment, semi-leptonic W boson decays were analyzed. The QCD background extracted from ATLAS data was scaled with the scale factor $0.35 \pm 0.05$ to match the integrated luminosity of the W decay data sets. Simulated sets of events with different W masses were looked at and for each known artificial mass, the half-maximum location of the smeared out Jacobi peak was found, and a gauge curve in the form of a linear function was fitted to these pairs. The real W boson mass of was read off the gauge curve after finding the half maximum of that data set, found to be $81.1 \pm 2.0$~GeV.
\end{abstract}
\end{@twocolumnfalse}
\hspace{5mm} ]
\maketitle
